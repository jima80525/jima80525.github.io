...
* Install [`uv`](https://docs.astral.sh/uv/getting-started/installation/) **and** [`direnv`](https://direnv.net/docs/installation.html).
* Create a `~/.config/direnv/direnvrc` file with the following content:
